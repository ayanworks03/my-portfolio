// Ported from Motion Primitives' <Magnetic> (https://motion-primitives.com/docs/magnetic):
// an element eases toward the cursor within `range`, falling back to its
// resting position once the cursor leaves — the spring config and distance
// math are kept as-is from the source.
