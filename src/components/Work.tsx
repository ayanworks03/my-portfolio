...
// The border is the wrapper's own background peeking through its padding —
// var(--border) at rest, and the glow div (a same-sized sibling, see
// useTiltSpotlight) fades in on top of that within the same gap on hover.
const WRAP_RADIUS = 7;
